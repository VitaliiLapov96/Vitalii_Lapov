...
import com.epam.spring.homework5.payments.repository.UserRepository;
import com.epam.spring.homework5.payments.service.UserService;
import com.epam.spring.homework5.payments.service.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDto getUser(Long userId) {
        ...
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new EntityNotFoundException(format("User with id %s is not found", userId)));
        return UserMapper.INSTANCE.mapUserToUserDto(user);
    }
    ...
    public UserDto updateUser(Long userId, UserDto updatedUserDto) {
        ...
        if (!userRepository.existsById(userId))
            throw new EntityNotFoundException(format("User with id %s is not found", userId));
