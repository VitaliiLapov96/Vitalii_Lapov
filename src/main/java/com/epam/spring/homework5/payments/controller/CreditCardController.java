package com.epam.spring.homework5.payments.controller;
...
public class CreditCardController {
    ...
    public List<CreditCardDto> listCreditCards(@RequestParam(defaultValue = "0") @Min(0) Integer page,
                                               @RequestParam(defaultValue = "10") @Min(10) Integer pageSize,
                                               @RequestParam(defaultValue = "creditCardId") String sortBy) {
        Pageable pageable = PageRequest.of(page, pageSize, Sort.by(sortBy));
        return creditCardService.listCreditCards(pageable);
    }
